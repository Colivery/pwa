...
export const SERVICE_API_ENDPOINT_VERSION = process.env.ST_SERVICE_API_ENDPOINT_VERSION;
...
export const GEOCODE_API_ENDPOINT = 'https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/geocodeAddresses';
export const GOOGLE_MAPS_API_KEY = 'AIzaSyAcko48zKZnhBP1RBFlIz6DO4E_0zEF9GU'
export const GOOGLE_MAPS_GEOCODE_API_ENDPOINT = 'https://maps.googleapis.com/maps/api/geocode/json';
export const GOOGLE_MAPS_STATIC_API_ENDPOINT = 'https://maps.googleapis.com/maps/api/staticmap';